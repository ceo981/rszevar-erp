...
const URL_TEMPLATES = {
  ...
  // Trax (Sonic) — verified from URL Jun 2026
  // App handle: trax-online-limited
  // Path: booking ; id = Shopify order ID
  trax: `https://admin.shopify.com/store/${STORE_HANDLE}/apps/trax-online-limited/booking?id={ORDER_ID}`,
};

/**
 * Constructs Shopify admin app URL for direct courier booking.
 * @param {'leopards'|'postex'|'trax'} courier
